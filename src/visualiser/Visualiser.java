...
public class Visualiser {
	...
	public static void displaySampleSpace(List<ASVState> states,List<Obstacle> ob){
		JFrame frame = new JFrame("Assignment 1 visualiser");
		Visualiser vis = new Visualiser(frame);
		ProblemSetup problemSetup = vis.vp.getProblemSetup();
		problemSetup.loadCSpace(states, ob);
